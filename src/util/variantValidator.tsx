...
export function isVariantValid(variant: string): VariantValidStatus {
    ...
    // is using hgvs representation
        ...
        if (variant.includes(VARIANT_OPERATOR.SNP)) {
            ...
            pattern =
                /^\b(chr[1-9]|chr1[0-9]|chr2[0-9]|chr3[0-8]|chr[XY]|(chrMT)|[1-9]|1[0-9]|2[0-9]|3[0-8]|[XY]|(MT))\b(:g.)[0-9]*[ATGC]>[ATGC]$/i;
        ...
        // DELINS
            ...
            pattern =
                /^\b(chr[1-9]|chr1[0-9]|chr2[0-9]|chr3[0-8]|chr[XY]|(chrMT)|[1-9]|1[0-9]|2[0-9]|3[0-8]|[XY]|(MT))\b(:g.)[0-9]*(?:_([0-9]*))?(delins)[ATGC]*$/i;
            if (variant.trim().match(pattern)) {
                return {
                    isValid: true,
                    message: VALIDATION_MESSAGE.VALID,
        ...
        // INS
            ...
            pattern =
                /^\b(chr[1-9]|chr1[0-9]|chr2[0-9]|chr3[0-8]|chr[XY]|(chrMT)|[1-9]|1[0-9]|2[0-9]|3[0-8]|[XY]|(MT))\b(:g.)[0-9]*_[0-9]*(ins)[ATGC]*$/i;
            if (variant.trim().match(pattern)) {
                return {
                    isValid: true,
                    message: VALIDATION_MESSAGE.VALID,
        ...
        // DEL
            ...
            pattern =
                /^\b(chr[1-9]|chr1[0-9]|chr2[0-9]|chr3[0-8]|chr[XY]|(chrMT)|[1-9]|1[0-9]|2[0-9]|3[0-8]|[XY]|(MT))\b(:g.)[0-9]*(?:_([0-9]*))?(del)$/i;
            if (variant.trim().match(pattern)) {
                return {
                    isValid: true,
                    message: VALIDATION_MESSAGE.VALID,
        ...
        // DUP
            ...
            pattern =
                /^\b(chr[1-9]|chr1[0-9]|chr2[0-9]|chr3[0-8]|chr[XY]|(chrMT)|[1-9]|1[0-9]|2[0-9]|3[0-8]|[XY]|(MT))\b(:g.)[0-9]*(?:_([0-9]*))?(dup)$/i;
            if (variant.trim().match(pattern)) {
                return {
                    isValid: true,
                    message: VALIDATION_MESSAGE.VALID,
